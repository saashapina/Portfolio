          ...
          <div className="bg"> 
              <div className="text-container">
                <div className="newtext" data-aos="fade-down" data-aos-delay="200">
                  <h1 className="text" style={colorwhite} typing={1} >SaaSha Pina</h1>
                  <Typing className="text2"><Typing.Delay ms={2500}/><span>Full Stack Software Engineer</span><Typing.Delay ms={1000}/><Typing.Backspace count={30}/> | 
